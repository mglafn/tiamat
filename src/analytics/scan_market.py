#!/usr/bin/env python3
"""
src/analytics/scan_market.py
----------------------------
Scans the latest 'NOW' market snapshot from DuckDB through the Two-Stage
Hurdle XGBoost model and ranks opportunities using Bayesian Expected ROI,
Continuous Kelly Criterion, or Expected Net Dollar Edge.
"""
...
def scan_market(
    ...
    # 2. Landed Basis & Payout Scenarios
    ...
    # Scenario B: Fail (Card stays flat at current price)
    ...
    # Apply Selected Theoretical Sort
    sort_columns = {
