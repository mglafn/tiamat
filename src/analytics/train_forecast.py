...
def print_header(db_path: str, model_output_dir: str):
    ...
    header_text.append("Two-Stage Hurdle Architecture  •  Asymmetric Objective  •  Conformal CQR Bounds\n", style="dim italic")
...
def train_xgboost_forecast(db_path: str, model_output_dir: str):
    ...
    with Progress(
        ...
        progress.update(task, description="[bold cyan][2/6] Training Asymmetric XGBRegressor on Movers...")
        ...
        regressor = XGBRegressor(
            ...
            random_state=42, n_jobs=4, objective=custom_asymmetric_objective
        )
